...
Revision ID: a3c0b0a326e3
Revises: 433edb953c60
Create Date: 2025-05-12 18:32:26.175890
...
revision: str = 'a3c0b0a326e3'
down_revision: Union[str, None] = '433edb953c60'
...
def upgrade() -> None:
    ...
    sa.Column('stock', sa.Enum('AVAILABLE', 'NOT_AVAILABLE', name='stockstatusenum'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PROCESSING', 'CANCELED', 'CLOSED', name='statusenum'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
